...
var IndexHandler = /** @class */ (function () {
    function IndexHandler(todoService, todoDbService) {
        this._todoService = todoService;
        this._todoDbService = todoDbService;
    }
    IndexHandler.prototype.defaultTodoHandler = function (event, context) {
    ...
    IndexHandler.prototype.testHandler = function (event, context) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log(event);
                return [2 /*return*/, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        todoItem = this._todoService.parseTodoPayload(event.body);
                        return [4 /*yield*/, this._todoDbService.saveTodo(todoItem)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
